...
// Reprendre l’exemple du cours et le faire fonctionner:
// Créer un programme qui exécute une boucle infinie jusqu’à ce que le signal SIGHUP soit reçu par le processus
